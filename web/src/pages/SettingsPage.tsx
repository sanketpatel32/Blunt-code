...
const DATA_FOLDERS = [
  { kind: 'reports', label: 'Reports', missing: 'The reports folder is created after your first scan.' },
  { kind: 'logs', label: 'Logs', missing: 'The logs folder is created when Blunt Code writes its first log.' },
  { kind: 'tools', label: 'Tools', missing: 'The tools folder is created when the first tool is installed.' },
  { kind: 'data', label: 'App data', missing: 'The app data folder is created the first time Blunt Code runs.' },
] as const;
