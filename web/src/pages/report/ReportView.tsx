 ...
 *  rule/path arrive from old shared URLs. Severity, type, tool, status, and the
 *  search box already show their own pressed state in the toolbar, so chips for
 *  them would only repeat the UI back at the user. */
