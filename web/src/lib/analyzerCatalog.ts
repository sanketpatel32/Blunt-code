...
/** Languages discovery currently classifies — must stay in sync with internal/discovery/discovery.go and internal/analyzers/analyzer.go. Dart/Elixir are UI-forward placeholders (no backend routing change yet). */
export const ALL_LANGUAGES = ['python', 'javascript', 'typescript', 'go', 'java', 'kotlin', 'csharp', 'c', 'cpp', 'ruby', 'php', 'rust', 'swift', 'scala', 'dart', 'elixir', 'objective-c', 'vue', 'svelte', 'html', 'css', 'scss', 'json', 'yaml', 'toml', 'xml', 'sql', 'graphql', 'shell', 'powershell', 'batch', 'markdown', 'dockerfile', 'env'] as const;

export type SupportedLanguage = typeof ALL_LANGUAGES[number];

export const LANGUAGE_FAMILIES: Record<string, readonly string[]> = {
  Systems: ['c', 'cpp', 'rust', 'go', 'java', 'csharp', 'scala', 'kotlin', 'swift', 'objective-c'] as const,
  ...
  Script: ['python', 'ruby', 'php', 'shell', 'elixir', 'powershell', 'batch'] as const,
...
export const ANALYZER_CATALOG: AnalyzerMeta[] = [
  ...
  { id: 'secrets', displayName: 'Secrets', category: 'secrets', languages: ['python', 'javascript', 'typescript', 'go', 'java', 'csharp', 'c', 'cpp', 'php', 'rust', 'swift', 'kotlin', 'scala', 'dart', 'elixir', 'ruby', 'shell', 'yaml', 'json', 'env', 'toml', 'xml', 'dockerfile', 'objective-c'], severityDefault: 'critical', icon: 'KeyRound', docUrl: 'https://docs.bluntcode.local/analyzers/secrets', enabledByProfile: ['quick', 'standard', 'deep'], description: 'Built-in credential and secret detection.' },
  { id: 'todo', displayName: 'Todo Scanner', category: 'maintainability', languages: ['python', 'javascript', 'typescript', 'go', 'java', 'csharp', 'c', 'cpp', 'php', 'rust', 'swift', 'kotlin', 'scala', 'dart', 'elixir', 'ruby', 'objective-c', 'shell'], severityDefault: 'info', icon: 'ListTodo', docUrl: 'https://docs.bluntcode.local/analyzers/todo', enabledByProfile: ['standard', 'deep'], description: 'Tracks TODO/FIXME and tech-debt markers.' },
